...
print("Best n_estimators:", grid.best_estimator_.get_params()['XGBoost__n_estimators'])
print("Best learning_rate:", grid.best_estimator_.get_params()['XGBoost__learning_rate'])
print("Best max_depth:", grid.best_estimator_.get_params()['XGBoost__max_depth'])
