...
- `degrad_orazem/` → modello di degradazione Orazem et al.
...
- `VAE/` → modello variational autoencoder per analisi dati
## Installazione
Il progetto è stato creato in modo tale da avere un virtual environment locale 'venv' all'interno della cartella del progetto.
Per l'installazione, 
